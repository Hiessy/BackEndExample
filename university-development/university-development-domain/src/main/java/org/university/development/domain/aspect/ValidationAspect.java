package org.university.development.domain.aspect;
...
public class ValidationAspect {
    ...
    @Pointcut("execution(* org.university.development.domain.feature..*.*(..))")
    private void selectAllFeatureMethods() {
    }

    @Pointcut("execution(* org.university.development.domain..*.*(..))")
